...
public enum AuditLogOption
{
     ...
     *     <li>{@link ActionType#MESSAGE_DELETE}</li>
     * </ul>
     * Use with {@link space.mrtuxa.kda.api.entities.Guild#getGuildChannelById(String) Guild.getGuildChannelById(String)}.
     *
     * <p>Expected type: <b>String</b>
     */
    CHANNEL("channel_id"),
    ...
    /**
     * Possible secondary target of an {@link net.dv8tion.jda.api.audit.ActionType ActionType}
     * such as {@link space.mrtuxa.kda.api.audit.ActionType#CHANNEL_OVERRIDE_CREATE ActionType.CHANNEL_OVERRIDE_CREATE}
